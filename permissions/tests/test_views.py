...
class PermissionsViewsTestCase(GenericViewTestCase):
    ...
    def test_role_creation_view_no_permission(self):
        ...
        self.assertFalse(TEST_ROLE_2_LABEL in Role.objects.values_list('name', flat=True))
    ...
    def test_role_creation_view_with_permission(self):
        ...
        self.assertTrue(TEST_ROLE_2_LABEL in Role.objects.values_list('name', flat=True))
    ...
    def _create_role(self):
        self.role_2 = Role.objects.create(name=TEST_ROLE_2_LABEL)
    ...
    def test_role_edit_view_no_access(self):
        ...
        self.assertEqual(Role.objects.count(), 2)
        self.assertEqual(self.role_2.name, TEST_ROLE_2_LABEL)
    ...
    def test_role_edit_view_with_access(self):
        ...
        self.assertEqual(Role.objects.count(), 2)
        self.assertEqual(self.role_2.name, TEST_ROLE_LABEL_EDITED)
