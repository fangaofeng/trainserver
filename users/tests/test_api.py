...
from users.registration.views import RegisterView
from users.registration.app_settings import register_permission_classes
...
class APIBasicTests(TestsMixin, TestCase):
    ...
    REGISTRATION_VIEW = 'users.runtests.RegistrationView'
    ...
    @override_settings(users_REGISTER_PERMISSION_CLASSES=(CustomPermissionClass,))
