...
class Theme(models.Model):
    ...
    logo = models.FileField(
        ...
        blank=True,
        help_text=_('Leave blank to use the default Django logo,thumbnail is heigth 55px'),
        verbose_name=_('logo'))

    logo_thumbnail = ImageSpecField(source='logo',
                                    processors=[ResizeToFit(height=55)],
                                    format='png',
                                    options={'quality': 90})
    footer = models.CharField(
        max_length=150,
        default=_('Copyright © 2007-2020 <a href="http://djangoproject.com">Djangoproject.com</a>.'),
        blank=True,
