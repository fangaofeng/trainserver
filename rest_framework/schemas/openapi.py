...
class SchemaGenerator(BaseSchemaGenerator):
    ...
    def get_paths(self,  request=None, public=False):
        ...
        for path, method, view in view_endpoints:
            if not self.has_view_permissions(path, method, view, public):
                continue
    ...
    def get_schema(self, request=None, public=False):
        ...
        paths = self.get_paths(request, public)
        if not paths:
            return None
...
class AutoSchema(ViewInspector):
    ...
    def _get_filter_parameters(self, path, method):
        ...
        if hasattr(self.view, 'get_filter_backends'):
            filter_backends = list(self.view.get_filter_backends())
        else:
            filter_backends = self.view.filter_backends
    ...
    def _allows_filters(self, path, method):
        ...
        """
        if hasattr(self.view, 'get_filter_backends'):   # genericsview can override this function
            return True
    ...
    def _get_request_body(self, path, method):
        ...
        if method == 'PATCH' and content.get('required', None):
