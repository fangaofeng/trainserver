...
from .models import Role, StoredPermission, Operation
...
class Operationerializer(serializers.ModelSerializer):
...
class RoleSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        extra_kwargs = {
            'url': {'view_name': 'rest_api:roles-detail'},
        }
...
class WritableRoleSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        fields = ('groups_pk_list', 'id', 'name', 'permissions_pk_list')
        model = Role
