...
#     def left_list(self):
#         return [
#             (force_text(role.pk), role.name) for role in set(Role.objects.all()) - set(self.get_object().roles.all())
#         ]
#
#     def right_list(self):
#         return [
#             (force_text(role.pk), role.name) for role in self.get_object().roles.all()
#         ]
#
...
#                 x.get_volatile_permission().namespace.name,
#                 x.get_volatile_permission().name
#             )
#         )
#
